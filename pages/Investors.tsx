                  ...
                  <tr key={inv.id} className="group hover:bg-primary-50/30 dark:hover:bg-primary-900/5 transition-all">
                    ...
                    <td className="px-6 py-5">
                      <Link to={`/investor/${inv.id}`} className="flex items-center gap-4">
                        <img src={getImgUrl(inv.logo, { width: 100 }) || 'https://picsum.photos/seed/' + inv.id + '/200'} className="w-12 h-12 rounded-xl object-cover shadow-lg group-hover:scale-110 transition-transform" alt="" />
