        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {project.editorsGuide && (
            <section className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border dark:border-slate-800 shadow-sm relative overflow-hidden mt-8">
              ...
              <div
                className="prose dark:prose-invert max-w-none font-medium text-slate-600 dark:text-slate-300 [&>p]:mb-1 [&>a]:text-purple-400 [&>a]:underline [&>h1]:text-xl [&>h1]:font-black [&>h1]:uppercase [&>h2]:text-lg [&>h2]:font-black [&>h2]:uppercase [&>img]:rounded-xl [&>img]:shadow-md"
